...
% 读取测试词汇ID
vocabulary = load('input\sign_1000_zeng.txt');
for i=1:1000
...
windowSizes(2) = 40;
windowSizes(3) = 60;
fidName = ['result\HMM_result' '_HierarSegModel_thre' num2str(thre) '_skip' ...
    num2str(sample) '_win' num2str(windowSizes(1)) num2str(windowSizes(2)) ...
    num2str(windowSizes(3)) '_random100_1000sign_BP3D_1in_2vots_G2.txt' ];
...
%                 end
                ...
                clc;
                fprintf('%s \n%s \n%s \n%s \n', showText_pace, showText_true, ...
                    showText_result1,showText_result2);
